                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="charts-apex-slope" class="nav-link">
                                                <span"><?php echo app('translator')->get('translation.slope'); ?></span> <span
                                                        class="badge badge-pill bg-success"><?php echo app('translator')->get('translation.new'); ?></span>
                                            </a>
                                        </li>
                                    </ul>
...
<?php /**PATH /home/dvg9zncdclpp/public_html/erp.moneyfrog.biz/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>