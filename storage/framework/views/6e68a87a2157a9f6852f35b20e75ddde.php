                    ...
                    <div class="col-12">
                        <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                            <div class="flex-grow-1">
                                <h4 class="fs-16 mb-1">Good Morning, <?php echo e(user_name() ?? 'User'); ?>!</h4>
...
<?php echo $__env->make('layouts.erp_master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\moneyfrog_erp\resources\views/index.blade.php ENDPATH**/ ?>