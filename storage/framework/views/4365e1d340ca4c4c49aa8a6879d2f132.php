            ...
            <div class="d-flex" style="flex-grow: 1;">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index" class="logo logo-dark">
                        <span class="logo-lg">
                            <img src="https://moneyfrog.in/images/new_home/logo-large.svg" alt="MoneyFrog" height="35">
                        </span>
                    </a>
                </div>

                <!-- App Search-->
                <form class="app-search d-none d-md-block ms-3" style="flex-grow: 1;">
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-semibold user-name-text"><?php echo e(user_name() ?? 'User'); ?></span>
                                <span class="d-none d-xl-block ms-1 fs-12 text-muted text-muted user-name-sub-text">Administrator</span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Welcome <?php echo e(user_name() ?? 'User'); ?>!</h6>
...
<?php /**PATH C:\wamp64\www\moneyfrog_erp\resources\views/layouts/erp_top_bar.blade.php ENDPATH**/ ?>